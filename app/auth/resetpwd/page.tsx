...
const Index = () => {
    return (
        <div className="w-full h-[100vh] relative overflow-hidden">
            <div className="h-full w-full flex flex-col gap-3 items-center mt-[15vh]">
                <div className="p-5 sm:px-10 md:px-0 sm:w-[550px] ">
                    ...
                    <div className="w-full flex flex-col gap-5 rounded-[15px] md:rounded-[30px] bg-[#F2F8FF] pt-8 md:pt-12 px-6 md:px-10 pb-7 md:pb-10">
                        <form action="" className="ctm-form flex flex-col w-full gap-5" onSubmit={e => e.preventDefault()}>
                            <h2 className="banner-subtitle w-full text-center mb-2">Reset Password</h2>
                            ...
                            <input type="password" className="main-input" placeholder="New Password" />
                            <input type="password" className="main-input" placeholder="Confirm New Password" />
                            {/* <input type="submit" value="Sent Reset Password Link" className="ctm-btn bg-[#007DFC] text-xl font-bold text-white w-full" /> */}
                            <button className="ctm-btn bg-[#007DFC] text-xl font-bold text-white w-full" >
                                <CustomLink href='/auth/resetsuccess' classname="">Sent Reset Password Link</CustomLink>
                            </button>
                        </form>
                    </div>
                </div>
