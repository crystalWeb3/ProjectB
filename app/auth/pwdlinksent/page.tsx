                ...
                <div className="p-5 sm:px-10 md:px-0 sm:w-[550px] ">
                    ...
                    <div className="w-full flex flex-col items-center gap-5 rounded-[15px] md:rounded-[30px] bg-[#F2F8FF] pt-8 md:pt-12 px-6 md:px-10 pb-7 md:pb-10">
                        ...
                        <div className="flex flex-col w-full gap-5" >
                            <h2 className="banner-subtitle w-full text-center mb-2">Reset Password Link Sent</h2>
                            ...
                            {/* <input type="submit" value="Go to your Email " className="ctm-btn bg-[#007DFC] text-xl font-bold text-white w-full" /> */}
                            <button className="ctm-btn bg-[#007DFC] text-xl font-bold text-white w-full" >
                                <CustomLink href='/auth/resetpwd' classname="">Sent Reset Password Link</CustomLink>
                            </button>
                        </div>
                    </div>
                </div>
