    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[100vh]">
            <div className="h-full w-full hidden lg:flex flex-col gap-8 items-center bg-[#F2F8FF] pt-[10%] ">
                ...
                <CustomLink href='/main/home'>
                    <div className="flex justify-center items-center">
                        {/* <span className="absolute w-[5.5vh]">
                            <Image src='/icon.png' width={100} height={100} layout="responsive" alt="icon"/>
                        </span> */}
                ...
                <CustomLink classname="flex w-full relative h-[43%] overflow-visible" href='/main/home'>
                    <div className="w-[35.5vh] absolute rotate-[-10deg] left-[44%] top-[4vh] translate-x-[-50%] overflow-visible z-30">
                        <Image 
                    ...
                    {/* <div className="w-[24vh] absolute rotate-[5deg] left-[55%] top-[10.5vh] translate-x-[-50%] overflow-visible z-30">
                        <Image 
                            ...
                            src='/football19.png' 
                            layout="responsive" alt="register19" 
                        />
                    </div>
                    <div className="w-[20.7vh] absolute left-[60%] top-[25vh] translate-x-[-50%] overflow-visible z-30">
                        <Image 
            ...
            <div className="relative h-full w-full flex flex-col gap-3 items-center justify-between">
                <div className="flex lg:hidden justify-center items-center pt-[4vw]">
                    <span>
                ...
                <div className="w-full px-[10%] sm:px-[20%] md:px-0 md:w-[450px] flex flex-col flex-1 justify-center gap-5">
                    <form action="" className="ctm-form flex flex-col w-full gap-6" onSubmit={handleSubmit}>
                        ...
                        <input type="text" className="main-input primary" name="email" value={formData.email} onChange={handleChange} placeholder="Email Address" />
                        <input type="password" className="main-input primary" name="password" value={formData.password} onChange={handleChange} placeholder="Password" />
                        <div className="w-full flex flex-col md:flex-row gap-y-4 justify-between items-center">
                                ...
                                <CustomLink href='/auth/recoverpwd' classname="underline banner-content">
                        ...
                        <p className="text-center w-full banner-content">
                            ...
                            <CustomLink href='/auth/register' classname="underline">
                                Signup
                            </CustomLink>
                        </p>
                    </form>
