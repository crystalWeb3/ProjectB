...
const Header = () => {
    return (
        <div className="relative ctm-container flex flex-col items-center pt-[135px] sm:pt-[140px] md:pt-[140px] lg:pt-[160px]">
            ...
            <div className="p-6 md:p-10 md:px-0 max-w-[700px] text-center flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col lg:flex-row flex-col-reverse gap-10 items-center p-7 md:p-0">
                <div className="w-[30%] hidden lg:flex flex-col gap-5">
                    <div>
                ...
                <div className="w-full lg:w-[70%] rounded-[38px] bg-[#F2F8FF] flex flex-col gap-10 p-10 md:p-16">
                    <div className="">
                    ...
                    <form className=" ctm-form flex flex-col gap-10 flex-1 ">
                        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="w-full flex flex-col gap-3">
                                <label htmlFor="name" className="text-lg md:text-2xl font-bold">Name</label>
                                <input id="name" type="text" placeholder="Name" className="main-input"/>
                            </div>
                            <div className="w-full flex flex-col gap-3">
                                <label htmlFor="e-mail" className="text-lg md:text-2xl font-bold">E-mail</label>
                                <input id="e-mail" type="text" placeholder="E-mail" className="main-input"/>
                            </div>
                        </div>
                        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="w-full flex flex-col gap-3">
                            ...
                            <div className="w-full flex flex-col gap-3">
                                ...
                                <input id="phonenum" type="text" placeholder="Phone Number" className="main-input"/>
                            </div>
                        </div>
                        <div className="w-full">
                            <div className="w-full flex flex-col gap-3">
                                <label htmlFor="message" className="text-lg md:text-2xl font-bold">Message</label>
                                <textarea id="message"  placeholder="Message" rows={10} className="main-input-textarea h-[215px]"/>
                            </div>
                        </div>
